...
@section('title', 'Input Denda')
@section('page-title', 'Input Denda')
@section('page-description', 'Tambahkan denda pada pembayaran reservasi yang telah lunas')
...
<div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-slate-400">
            Tambahkan nominal denda untuk reservasi yang telah lunas.
        </p>
    </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500">
                    Masukkan nominal denda yang dikenakan kepada pelanggan.
                </p>
            </div>
        ...
        >
            ...
            >
                ...
                <div class="mb-5">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Masukkan nominal denda yang harus dibayarkan pelanggan.
                    </p>
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        ...
                        {{-- NILAI ASLI YANG DIKIRIM KE CONTROLLER --}}
                        <input
                            type="hidden"
                            name="denda"
                            id="denda"
                ...
                >
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs leading-5 text-amber-700">
                            Pastikan nominal denda sudah benar sebelum disimpan.
                            Denda akan tercatat pada pembayaran reservasi ini.
                        </p>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    /*
     * Format old value ketika validasi gagal
     */
